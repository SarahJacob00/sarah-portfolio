$(function(){
    ...
    /* If you Use Text */
        ...
        var sparkCss = [
                        {color: '#f2f26b92', display: 'inline-Block'},
                        {color: '#dcdc6f', display: 'inline-Block'},
                        {color: '#eaeaa0', display: 'inline-Block'},
                        {color: '#f8f8f7', display: 'inline-Block'}
                        ];
    ...
    */
        ...
        // sparks = sparks || ['&#9733;', '&#9733;', '&#9733;', '&#9733;', '&#9733;'];
        // sparkCss = sparkCss || [
        //                 {color: '#FF0', display: 'inline-Block', cursor: 'none'},
        //                 {color: '#FF0', display: 'inline-Block', cursor: 'none'},
        //                 {color: '#FF0', display: 'inline-Block', cursor: 'none'},
        //                 {color: '#FF0', display: 'inline-Block', cursor: 'none'},
        //                 {color: '#FF0', display: 'inline-Block', cursor: 'none'}
        ...
        $target.mousemove(function (e){
            ...
            if (i % release == 0){
                if (type == 'image') {
                    ...
                    $spark.css({fontSize: Math.round(Math.random() * 150 + 30) + '%'});
                }
                $target.append($spark);
